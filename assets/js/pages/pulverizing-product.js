$(document).ready(function() {
    ...
    $("#datatable-buttons").DataTable({
        ...
        "initComplete": function(settings, json) {
            ...
            <button type="button" data-toggle="modal" data-target=".addstore" class="btn btn-success btn-rounded waves-effect waves-light mb-2 mr-2"><i class="mdi mdi-plus mr-1"></i> Add To Store </button>
                <button type="button" data-toggle="modal" data-target=".add" class="btn btn-success btn-rounded waves-effect waves-light mb-2 mr-2"><i class="mdi mdi-plus mr-1"></i> Create New Product details</button>
            </div>`);
