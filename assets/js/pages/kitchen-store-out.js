    ...
    $("#datatable-buttons").DataTable({
        ...
        "initComplete": function(settings, json) {
            $(".dataTables_filter").parent().append(`<div class="text-sm-right">
                <button type="button" data-toggle="modal" data-target=".add" class="btn btn-success btn-rounded waves-effect waves-light mb-2 mr-2"><i class="mdi mdi-plus mr-1"></i> Add Store Out</button>
            </div>`);
...
$(document).on('click', '#button-add-item', function() {
    ...
    <th scope="row">
        <div class="form-group">
            ...
            <option value="ITE0002">ITE0002 - Idly</option>
        </select>
        </div>
    </th>
    <td> <input type="text" class="form-control" id="formrow-firstname-input"> </td>
    <td> <input type="text" class="form-control" id="formrow-firstname-input"> </td>
</tr>`);
});
